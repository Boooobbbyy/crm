            ...
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    ...
                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                        <span class="viewjumlah"></span> Data Masuk
                    </div>
                </div>
                <div class="col-auto">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Daftar Data Masuk</h6>
    </div>
    <div class="ml-3 mt-2">
        <button type="button" class="btn btn-primary tomboltambah">
            <i class="fa fa-plus-circle"></i> Tambah Data
        </button>
        <a href="<?= base_url('SuratMasuk/print') ?>" class="btn btn-primary">print Form</a>
    </div>
    <div class="card-body">
